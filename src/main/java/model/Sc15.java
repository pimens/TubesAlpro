...
public class Sc15 extends ModelJSON {
                                ...
                                if (m.cekTimeGr(departure, sc.getString("dep"))) {
                                    ...
                                    if (m.cekTimeGr(departure, arrNewSc)) {  // 1111 cek tngh malam
                                        ...
                                        if (m.cekTimeGr(sc.getString("dep"), arrAtSameStation)) {// 222 kalao tnghmalam dan kereta jg tngah mlm bsa cek slish
                                            ...
                                            if (selisih < (w+15)) {//3333
                                                cekKA = 1;
                                            } else {

                                            }
                                        } else {//444
                                            LocalTime depPlus15 = LocalTime.parse(sc.getString("dep"));
                                            String newDep = df.format(depPlus15.minusMinutes(15));
                                            if (isHourInInterval(arrNewSc, newDep, arrAtSameStation)) {
